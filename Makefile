...
$(OBJDIR_DEBUG)/peripheral/ltb.o: peripheral/ltb.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c peripheral/ltb.cpp -o $(OBJDIR_DEBUG)/peripheral/ltb.o
...
$(OBJDIR_DEBUG)/mcu/datalabels.o: mcu/datalabels.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c mcu/datalabels.cpp -o $(OBJDIR_DEBUG)/mcu/datalabels.o
...
$(OBJDIR_RELEASE)/peripheral/ltb.o: peripheral/ltb.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c peripheral/ltb.cpp -o $(OBJDIR_RELEASE)/peripheral/ltb.o
...
$(OBJDIR_RELEASE)/mcu/datalabels.o: mcu/datalabels.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c mcu/datalabels.cpp -o $(OBJDIR_RELEASE)/mcu/datalabels.o
